...
namespace DefaultConnection
{
    ...
    public partial class tb_User : DefaultConnectionDB.Record<tb_User>  
    {
		...
		[Column] public int? OrgID { get; set; }
		...
		[Column] public byte? UserType { get; set; }
		...
		[Column] public DateTime? PrveLoginTime { get; set; }





		[Column] public string PrveLoginIP { get; set; }
